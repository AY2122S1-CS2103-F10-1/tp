...
import static seedu.address.logic.commands.RejectionRateCommand.*;
...
public class RejectionRateCommandTest {
    ...
    public void execute_existingPositionWithoutApplicant_successful() throws Exception {
        assertEquals(new CommandResult(MESSAGE_NO_CURRENT_APPLICANTS), new RejectionRateCommand(DATASCIENTIST.getTitle()).execute(model));
    }
    ...
    public void execute_existingPositionWithExistingApplicant_successful() throws Exception {
        ...
        float rejectionRate = model.calculateRejectionRate(DATASCIENTIST);
...
//        Applicant applicant = new Applicant(applicantParticulars, validPosition).markAs(ApplicationStatus.REJECTED);
//
//        model.addApplicantWithParticulars(applicantParticulars);
//
//        float initialRejectionRate = model.calculateRejectionRate(validPosition);
//
//        ApplicantParticulars otherApplicantParticulars = new ApplicantParticulars(new Name("Bob"), new Phone("12345678")
//                , new Email("test@gmail.com")
//                , new Address("Blk 123, Jurong West Ave 6, #08-111")
//                , validPosition.getTitle());
