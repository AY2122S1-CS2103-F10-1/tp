...
| `* * *`  | user                                       | delete a applicant                | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a applicant by name          | locate details of applicants without having to go through the entire list |
| `* *`    | user                                       | hide private contact details   | minimize chance of someone else seeing them by accident                |
| `*`      | user with many applicants in the address book | sort applicants by name           | locate a applicant easily                                                 |
